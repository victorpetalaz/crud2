...
python app.py
    ...
    curl -X POST [http://127.0.0.1:5000/games](http://127.0.0.1:5000/games) -H "Content-Type: application/json" -d "{\"title\": \"Bloodborne\", \"plat\": \"PS4\", \"yr\": 2015}"
    ...
    curl [http://127.0.0.1:5000/games](http://127.0.0.1:5000/games)
    ...
    curl [http://127.0.0.1:5000/games/1](http://127.0.0.1:5000/games/1)
    ...
    curl -X PUT [http://127.0.0.1:5000/games/1](http://127.0.0.1:5000/games/1) -H "Content-Type: application/json" -d "{\"title\": \"Bloodborne GOTY\", \"plat\": \"PS4\", \"yr\": 2015}"
    
    5. DELETE (Remover)
    O que é: Envia um método de exclusão para a URL de um ID específico.
    Por que usar: Para excluir um registro do banco via ID.
    curl -X DELETE [http://127.0.0.1:5000/games/1](http://127.0.0.1:5000/games/1)